...
?>
        ...
        <div class="glide__track" data-glide-el="track">
            <ul class="glide__slides">
				...
				foreach ( $my_posts as $post ) {
					setup_postdata( $post );
					?>
                    <li style="background-image: url('<?php the_field( 'slider_image' ); ?>)"
                        class="glide__slide">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-1">
                                    <h2 style="
									<?php $field = get_field( 'slider_text_color' );
									if ( $field === 'white' ) {
										?>
                                            color: #fff;
										<?php
									...
									<?php $field = get_field( 'slider_button' );
									if ( $field === 'on' ) {
										?>
            ...
            <div class="row">
                <div class="col-md-10 offset-md-1 col-lg-5 offset-lg-1">
                    <div class="about__img">
						<?php $image = get_field( 'image_in_about_company_block' );
						if ( ! empty( $image ) ): ?>
                            <img
                ...
                <div class="col-md-10 offset-md-1 offset-lg-0 col-lg-6 col-xl-5 offset-xl-1">
                    <h1 class="title underlined"><?php the_field( 'title_in_company_description_block' ); ?></h1>
                    <div class="about__text">
						<?php the_field( 'description_in_company_description_block' ); ?>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="toys__alert">
                        <span>
                            <?php the_field( 'if_user_dont_find_smth' ); ?>>
                        </span>
                    </div>
                </div>
            </div>
    ...
    <div class="aboutus" id="aboutus">
        <div class="container">
            <h1 class="title"><?php the_field( 'our_mission_title' ); ?></h1>
            <div class="row">
                <div class="col-lg-6">
                    <div class="subtitle">
						<?php the_field( 'our_mission_first_block_title' ); ?>
                    </div>
                    <div class="aboutus__text">
						<?php the_field( 'our_mission_first_block_description' ); ?>
                    </div>
                </div>
                <div class="col-lg-6">
					<?php $image = get_field( 'our_team_image' );
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="aboutus__text">
                        ...
                        что
                        идут в ногу со временем. Добавляя электроники и оживляя лучших друзей ребятишек, мы всегда
                        следим за
                            ...
                            <ul class="glide__slides">
                                ...
                                <li class="glide__slide">
                                    ...
                                    <div class="feedslider__text">
                                        ...
                                        жалею!
                                        Мишка именно такой, как я хотела, прямо как у меня в детстве: мягкий, приятный
                                        на
